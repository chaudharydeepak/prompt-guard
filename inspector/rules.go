...
var BuiltinRules = []Rule{
	...
	},
	{
		...
		Description: "Variable assignment containing secret/password/token keyword",
		Pattern:     regexp.MustCompile(`(?i)(secret|password|passwd|token|api_key|apikey)\s*[=:]\s*['"]?[a-zA-Z0-9+/!@#$%^&*]{8,}['"]?`),
		Severity:    SeverityMedium,
	},
	{
		ID:          "ssn",
